...
#import "CCUIContainerDemo09VC.h"
#import "WDZWDZEcDetailScrollMain.h"

@interface CCUIContainerDemo09VC ()
@property(nonatomic,strong) WDZWDZEcDetailScrollMain *mainView;
@end

@implementation CCUIContainerDemo09VC
...
- (void)viewDidLoad {
    ...
    self.mainView = [WDZWDZEcDetailScrollMain new];
