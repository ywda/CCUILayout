...
#import "CCUIContainerDemo07VC.h"
...
@interface CCUIContainerDemo07VC ()

@end

@implementation CCUIContainerDemo07VC
...
- (NSMutableArray*) createInstantiationUiElements
{
    ...
    NSMutableArray<CCUIContainerUiMode*>*uims = [NSMutableArray array];
    
    
    WDZLoginCenterItem00 * item0 = [WDZLoginCenterItem00 new];
    CCUIContainerUiMode *em0 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em1 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em2_0 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em2_1 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em3 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em4 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em5 = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *sem = [CCUIContainerUiMode new];
    ...
    CCUIContainerUiMode *em6 = [CCUIContainerUiMode new];
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = CCUIContainer_RANDOM_COLOR_LIGHT;
