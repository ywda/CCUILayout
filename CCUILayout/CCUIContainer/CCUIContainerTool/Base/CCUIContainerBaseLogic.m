...
@implementation CCUIContainerBaseLogic
...
{
    CCUIContainerBaseLogic *result= [CCUIContainerBaseLogic new];
    ...
    // MARK: 安全检查
    NSMutableArray<CCUIContainerUiMode*> * tmpAry = [NSMutableArray array];
    NSMutableSet *tmpBinds = [NSMutableSet set];
    
    for (NSInteger i = 0; i < subUis.count; i++) {
        
        CCUIContainerUiMode *clm = subLModes[i];
