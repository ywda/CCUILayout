//
//  CCUILayoutDemo03VC.m
//  CCUILayout
//  MARK: 模拟从创建的实例数组快速创建 页面 demo 父类 CCUILayoutBaseVC
...
@interface CCUILayoutDemo03VC ()

@end

@implementation CCUILayoutDemo03VC
...
- (void) simulation_navBar
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        for (CCUILayoutUiMode *object in ws.subviewModes) {
            if ([object.bind integerValue] % 2 !=0) {
                [newTmp addObject:object];
            }
        }
        [self updateUIControls:[NSMutableArray arrayWithArray:newTmp]];
